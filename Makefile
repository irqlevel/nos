...
UBSAN ?=
FLAVOR = $(if $(filter 1,$(UBSAN)),ubsan,plain)
OUT = out/$(ARCH)$(if $(filter ubsan,$(FLAVOR)),-ubsan)
...
CXXFLAGS += $(if $(filter ubsan,$(FLAVOR)),$(UBSAN_CXXFLAGS))
