...
This file is the authoritative copy of the project's rules; there is no other. First which language new code is in, then the non-obvious rules -- C++ first, and then what goes for both:
