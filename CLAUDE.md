...
- `src/cpp/net/` — **only the device abstraction is left**; everything else, the frame pool included, is Rust (`src/rust/net`), reached through one file each here
