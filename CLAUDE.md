...
- `src/cpp/block/` — async interrupt-driven block request queue, the device table and its claims (the partition tables themselves are read in Rust, `src/rust/block`)
