...
- `src/cpp/net/` — **only the device abstraction and the frame pool are left**; everything above them is Rust (`src/rust/net`), reached through one file each here
